...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/auto_verde_derecha.png', 40, 40, 30, 15, 1),
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 490, 290, 30, 30, 1),
    new Obstaculo('imagenes/auto_verde_arriba.png', 280, 140, 15, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 810, 80, 15, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 810, 100, 15, 30, 1),
    new Obstaculo('imagenes/auto_verde_derecha.png', 790, 480, 30, 15, 1),
  ],
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 500, 260, 10, 10, 5, {'desdeX': 0, 'hastaX': 961, 'desdeY': 0, 'hastaY': 577}),
    new ZombieCaminante('imagenes/zombie2.png', 360, 122, 10, 10, 5, {'desdeX': 0, 'hastaX': 961, 'desdeY': 0, 'hastaY': 577}),
    new ZombieCaminante('imagenes/zombie3.png', 470, 505, 10, 10, 2, {'desdeX': 0, 'hastaX': 961, 'desdeY': 0, 'hastaY': 577}),
    new ZombieCaminante('imagenes/zombie4.png', 890, 365, 10, 10, 1, {'desdeX': 0, 'hastaX': 961, 'desdeY': 0, 'hastaY': 577}),
    new ZombieCaminante('imagenes/zombie3.png', 900, 531, 10, 10, 5, {'desdeX': 0, 'hastaX': 961, 'desdeY': 0, 'hastaY': 577}),
    new ZombieCaminante('imagenes/zombie2.png', 800, 146, 10, 10, 4, {'desdeX': 0, 'hastaX': 961, 'desdeY': 0, 'hastaY': 577}),
    new ZombieCaminante('imagenes/zombie1.png', 152, 376, 10, 10, 3, {'desdeX': 0, 'hastaX': 961, 'desdeY': 0, 'hastaY': 577}),
    new ZombieConductor('imagenes/tren_horizontal.png', 400, 325, 90, 30, 9, {'desdeX': -300, 'hastaX': 1300},'H'),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 132, 30, 90, 5, {'desdeY': -230, 'hastaY': 880},'V'),
    new ZombieConductor('imagenes/tren_vertical.png', 674, 0, 30, 90, 7, {'desdeY': -230, 'hastaY': 850},'V')
  ]
...
// Dibujar meta. Primero establezco el fondo blanco con variables para que se visualice mejor.
Juego.dibujarMeta = function(){
  ...
  let width = 128;
  let height = 32;
  Dibujante.dibujarRectangulo(color, x, y, width, height);
  
  // Luego añado los cuadrados negros. Variable i debe ir sumando 32 para que se vea el cuadro blanco.
  for (let i = 759; i < 887; i+=32) {
    Dibujante.dibujarRectangulo('black', i, 520, 16, 16);
    // Si i es 16 unidades más pequeña, iniciar el dibujante 16 unidades adelante para que el primer cuadro sea blanco.
    if (i < 871 ) {
      Dibujante.dibujarRectangulo('black', i+16, 536, 16, 16);
    }
  }
}
